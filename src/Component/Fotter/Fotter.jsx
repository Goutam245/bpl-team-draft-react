...
const Fotter = () => {
    return (
        <div className="bg-[#080844] relative">
            <div className='border border-white p-5 absolute left-1/2 transform -translate-x-1/2 rounded-xl w-full lg:max-w-7xl top-[-18%] lg:top-[-25%]'>
                    <div className='bg-white bg-gradient-to-tr from-[#bceaff] to-[#fdf3bf] rounded-xl flex flex-col items-center justify-center gap-4 px-2 py-10 sm:py-20'>
                        <h1 className='text-3xl font-bold text-center'>Subscribe to our Newsletter</h1>
                        <p className='text-gray-500 font-semibold text-center'>Get the latest updates and news right in your inbox!</p>
                        <div className='flex flex-col sm:flex-row items-center justify-center gap-2'>
                            <input className='bg-white p-3 md:w-96 outline-none rounded-lg' type="email" placeholder='Enter your email' />
                            <button className='btn btn-warning w-full sm:w-auto'>Subscribe</button>
                        </div>
                    </div>
            </div>
                    ...
                    <div>
                        ...
                        <ul className='text-[#FFFFFF99] mt-3'>
                            ...
                            <div className='mt-4 flex items-center'>
                                ...
                                <button className='py-3 bg-orange-400 px-2 rounded-r-md text-white'>Subcribe</button>
                            </div>
                        </ul>
                    </div>
                </div>
